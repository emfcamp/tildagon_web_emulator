"""
Taken from https://github.com/TheAlgorithms/Python/blob/master/conversions/rgb_hsv_conversion.py
...
def rgb_to_hsv(red: float, green: float, blue: float) -> Tuple[float]:
    """
